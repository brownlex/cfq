...
@section('content')
    <div class="container" style="height: auto; ">
        ...
        <form method="post" action="{{ route('client.create.step.two1') }}" autocomplete="off" class="form-horizontal">
            @csrf
            <div class="container"
                ...
                <div class="row">
                    <label class="col-sm-3 col-form-label text-right"
                        style="color: rgb(0, 0, 0) !important;">{{ __('First Name:') }}</label>
                    <div class="col-sm-3 text-left">
                        <input type="text" class="use-keyboard-input" style="width: 250px;" name="name">
                    </div>
