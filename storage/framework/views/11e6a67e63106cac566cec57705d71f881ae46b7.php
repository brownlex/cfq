          ...
          <form method="post" action="<?php echo e(route('profile.password')); ?>" class="form-horizontal">
            ...
            <div class="card ">
              <div class="card-header card-header-info">
                ...
                <p class="card-category"><?php echo e(__(auth()->user()->name)); ?></p>
              </div>
              <div class="card-body ">
...
<?php echo $__env->make('layouts.app', ['activePage' => 'profile', 'titlePage' => __('User Profile')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\inv_sys\resources\views/profile/edit.blade.php ENDPATH**/ ?>