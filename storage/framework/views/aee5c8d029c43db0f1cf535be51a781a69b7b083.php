...
<?php $__env->startSection('content'); ?>
    <div class="container" style="height: auto; ">
        ...
        <form method="post" action="<?php echo e(route('client.create.step.two1')); ?>" autocomplete="off" class="form-horizontal">
            <?php echo csrf_field(); ?>
            <div class="container"
...
<?php echo $__env->make('layouts.app2', ['class' => 'off-canvas-sidebar', 'activePage' => 'home', 'title' => __('MVA Fund Customer Satisfaction System')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\cfq\resources\views/auth/create-step-two.blade.php ENDPATH**/ ?>